...
from tactile_feature_extraction.pytorch_models.supervised.image_generator import FrameDataset
...
def launch():
    ...
    for task in tasks:
        for model_type in models:
            ...
            features_dir = 'Dataset_and_Trained_Models/features'
